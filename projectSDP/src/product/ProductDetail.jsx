                ...
                <div className="md:w-1/2 flex flex-col justify-between">
                    <div>
                        ...
                        <p className="text-gray-200 leading-relaxed">
                            ...
                            convallis, nulla at sagittis varius, justo neque faucibus enim,
                            ac interdum nunc elit a ex. Curabitur fermentum est vel augue
                            aliquet, ac dictum neque tincidunt.
                        </p>
                    </div>
