...
const Product = () => {
  ...
  return (
    <div className="product-page px-6 py-8 max-w-[1400px] mx-auto min-h-screen pb-16">
      <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4 relative z-10">
        ...
        <div className="relative w-full sm:w-auto" ref={dropdownRef}>
          ...
          <ul
            className={`absolute left-0 mt-2 w-full sm:w-auto bg-white text-gray-900 rounded shadow-lg overflow-y-auto max-h-64 transition-all duration-300 origin-top z-50 ${
              dropdownOpen
