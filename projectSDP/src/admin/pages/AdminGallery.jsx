...
import { Plus, Trash2, Image as ImageIcon, Upload, X, CheckCircle, AlertCircle } from "lucide-react";
...
const GalleryPage = () => {
    ...
    const handleToggleActive = async (id, currentActive) => {
        try {
            ...
            if (response.ok) {
                fetchGallery();
                showSuccessPopup(`Gambar berhasil ${!currentActive ? 'diaktifkan' : 'dinonaktifkan'}`);
            } else {
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-600 mt-2">Kelola gambar gallery untuk halaman About Us</p>
                </div>
                <button
                            ...
                            <form onSubmit={handleAddGallery} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800 transition"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows="3"
                                        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800 resize-none transition"
                                    />
                                </div>
                                ...
                                <div className="flex gap-3 pt-4">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {uploading ? (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-xl max-w-sm w-full p-6 transform transition-all">
                        <div className="flex items-center gap-3 mb-4">
                            <div className={`p-2 rounded-full ${popupData.type === 'success' ? 'bg-green-100 text-green-600' :
                                popupData.type === 'error' ? 'bg-red-100 text-red-600' :
                                    'bg-blue-100 text-blue-600'}`}>
                                {popupData.type === 'success' ? <CheckCircle size={24} /> :
                                    popupData.type === 'error' ? <AlertCircle size={24} /> :
                                        <AlertCircle size={24} />}
                            </div>
                            <h3 className="text-lg font-semibold text-gray-900">{popupData.title}</h3>
                        </div>

                        <p className="text-gray-600 mb-6">{popupData.message}</p>

                        <div className={`flex gap-3 ${popupData.showCancel ? 'justify-between' : 'justify-end'}`}>
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 rounded-lg transition font-medium ${popupData.type === 'success' ? 'bg-green-600 text-white hover:bg-green-700' :
                                    popupData.type === 'error' ? 'bg-red-600 text-white hover:bg-red-700' :
