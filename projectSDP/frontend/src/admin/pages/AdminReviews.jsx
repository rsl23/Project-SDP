        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 403) {
                    ...
                    // Other errors
                    toast.error(`Gagal menghapus review: ${responseData.error || 'Unknown error'}`);
                }
            }
        } catch (error) {
        ...
        try {
            ...
            if (userDoc.exists()) {
                ...
                if (userData.role !== "admin") {
                    toast.error(`Role Anda: ${userData.role || 'user'}. Hanya admin yang dapat menghapus review.`);
                }
            } else {
                console.log("❌ User document not found in Firestore");
                toast.error("Data user tidak ditemukan. Pastikan Anda memiliki akses admin.");
            }
        } catch (error) {
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <p className="mt-3 md:mt-4 text-gray-600 text-sm md:text-base">Memuat reviews...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
                    ...
                    <div className="bg-white rounded-lg md:rounded-xl p-3 md:p-4 lg:p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">{stats.average}</div>
                    ...
                    <div className="bg-white rounded-lg md:rounded-xl p-3 md:p-4 lg:p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">{stats.rating5}</div>
                                <div className="text-xs sm:text-sm text-gray-600">5 Bintang</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg md:rounded-xl p-3 md:p-4 lg:p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <div className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">{stats.rating1}</div>
                                <div className="text-xs sm:text-sm text-gray-600">1 Bintang</div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-20 max-h-48 sm:max-h-60 overflow-y-auto">
                                    <div className="p-2 space-y-1">
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded transition-colors flex items-center justify-between text-xs md:text-sm ${selectedProduct === "all" ? "bg-indigo-100 text-indigo-700" : "hover:bg-gray-100"}`}
                                        >
                                        ...
                                        {products.map(product => (
                                            <button
                                                ...
                                                className={`w-full text-left px-3 py-2 rounded transition-colors flex items-center justify-between text-xs md:text-sm ${selectedProduct === product.id ? "bg-indigo-100 text-indigo-700" : "hover:bg-gray-100"}`}
                                            >
                                ...
                                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                                    <div className="p-2 space-y-1">
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded transition-colors flex items-center justify-between text-xs md:text-sm ${ratingFilter === "all" ? "bg-indigo-100 text-indigo-700" : "hover:bg-gray-100"}`}
                                        >
                                        ...
                                        {[5, 4, 3, 2, 1].map((rating) => (
                                            <button
                                                ...
                                                className={`w-full text-left px-3 py-2 rounded transition-colors flex items-center justify-between text-xs md:text-sm ${ratingFilter === rating.toString() ? "bg-indigo-100 text-indigo-700" : "hover:bg-gray-100"}`}
                                            >
                                                <div className="flex items-center gap-2">
                                                    <div className="flex items-center gap-1">
                                                        {[1, 2, 3, 4, 5].map((star) => (
                ...
                {filteredReviews.length === 0 ? (
                    ...
                    <div className="grid gap-4 sm:gap-6">
                        {filteredReviews.map((review) => (
                            <div key={review.id} className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50">
                        <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto mx-2 sm:mx-4">
                            <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
                                <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Detail Review</h3>
                                <button
                            ...
                            <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                                ...
                                {selectedReview.komentar && (
                                    <div>
                                        <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">Komentar</h4>
                                ...
                                {/* Product Info */}
                                <div>
                                    <h4 className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">Produk</h4>
                        ...
                        <div className="bg-white rounded-xl w-full max-w-md mx-2 sm:mx-4">
                            <div className="p-4 sm:p-6">
                                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                                    ...
                                    <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Hapus Review</h3>
                                </div>
